/**
 *  \defgroup tools supporting tools
 *  \brief The \b sofs18 suppoting tools.
 *
 *  \author Artur Pereira - 2005--2018
 ...
 *  \ingroup tools
 *  \brief The \b sofs18 mounting program.
 * 
 *  \details 
 *      It provides a simple method to integrate the sofs18 file system into Linux.
 *
 */
...
/* SOFS18 support filename (should be the absolute path) */
 ...
 */
const struct fuse_operations sofs18_fuse_operations = {
...
int main(int argc, char *argv[])
{
    ...
    return fuse_main(fargc, fargv, &sofs18_fuse_operations, NULL);
}
